#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# skills/j-jenga/scripts/render-confirmation.sh
#
...
# `skills/j-jenga/scripts/cascade-resolve.sh` (E45_S01_T03) as a
...
# USAGE
# ---------------------------------------------------------------------------
#   skills/j-jenga/scripts/render-confirmation.sh "<comma-separated-ids>"
...
#
#   skills/j-jenga/scripts/render-confirmation.sh <state_file> "<raw_reply>"
