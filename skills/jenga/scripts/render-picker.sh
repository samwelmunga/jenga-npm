#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# skills/jenga/scripts/render-picker.sh
#
...
# sourced from `skills/jenga/scripts/board-scan.sh` (E45_S01_T01) — this
...
#
#   skills/jenga/scripts/render-picker.sh <state_file> "<raw_reply>"
