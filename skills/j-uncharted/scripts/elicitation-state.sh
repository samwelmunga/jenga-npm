#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# skills/j-uncharted/scripts/elicitation-state.sh
#
...
# to persist. All of that judgement lives in skills/j-uncharted/SKILL.md's
...
#       file's path, per skills/j-uncharted/SKILL.md's Multi-Session
