...
print_manual_steps() {
  ...
  case "$TARGET_TYPE" in
    droplet)
      adapter_doc="$PUBLISH_REPO_ROOT/skills/j-publish/adapters/droplet.md"
      ;;
    npm)
      adapter_doc="$PUBLISH_REPO_ROOT/skills/j-publish/adapters/npm.md"
      ;;
    npm-ci)
      adapter_doc="$PUBLISH_REPO_ROOT/skills/j-publish/adapters/npm-ci.md"
      ;;
    mobile-ios)
      adapter_doc="$PUBLISH_REPO_ROOT/skills/j-publish/adapters/mobile-ios.md"
      ;;
    *)
      return 0
      ;;
