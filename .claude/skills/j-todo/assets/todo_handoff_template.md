...
<!-- PREAMBLE (for /todo): This template was pre-filled by a caller (e.g. /redo, /spinoff).
...
## Mission Title
<!-- PLACEHOLDER: short name for this todo item, e.g. "Refactor auth middleware" -->

## Goal / Objective
<!-- PLACEHOLDER: what this todo is trying to achieve -->

## Affected Files or Scope
<!-- PLACEHOLDER: which files, modules, or areas are involved, e.g. src/auth/, skills/j-todo/ -->
