#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# skills/j-reconcile/scripts/resolve-reconcile-scope.sh
#
...
# id-range expansion for `/reconcile` — `skills/j-reconcile/SKILL.md` (wired in
...
#     "owned_path_hints": ["skills/j-reconcile/", "..."]
#   }
#
