#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# skills/j-jenga/scripts/resolve-id.sh
#
...
# produced by `skills/j-jenga/scripts/board-scan.sh` (E45_S01_T01).
#
...
# USAGE
# ---------------------------------------------------------------------------
#   skills/j-jenga/scripts/resolve-id.sh "<comma-separated raw ID list>"
#
# Example:
#   skills/j-jenga/scripts/resolve-id.sh "E01s02, e01 S04 t02, 0103"
#
